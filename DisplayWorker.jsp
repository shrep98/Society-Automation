...
for(int i=0;i<wList.size();i++)
{
	...
	%>
			<tr>
				<td><input type="radio" name="Work_Id" value="<%= v.Work_Id %>"></td>
				<td><%= v.Work_Id %></td>
				<td><%= v.FName %></td>
				<td><%= v.LName %></td>
				<td><%= v.Address %></td>
...
<tr>
	<td colspan="7"><center><input type="submit" value=" Update "> </a> </center></td>
</tr>
