...
<li><a href="Needs.jsp" style="text-decoration:none;color=#000000;">Needs<br></a></li>
  ...
  <li><a href="DisplayNeed.jsp" style="text-decoration:none;color=#000000;">Display Lives<br></a></li>
</ul>
</div>
<div class="mid-right">
<h1>Needs Display</h1>

<form action="DisplayNeed.jsp" method="post">
<table border="1">
...
<%
     ArrayList<Needs> nList = Needs.getAllNeeds();
	 Needs l;
