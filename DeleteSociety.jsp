...
</div><div class="mid-right">
<h1>Society Delete</h1>
...
for(int i=0;i<societyList.size();i++)
{
	...
	%>
			<tr>
				...
				<td><%= s.City %></td>
				<td><%= s.Pincode %></td>
				<td><a href="DeleteSociety?Soc_Id=<%= s.Soc_Id %>" style="text-decoration:none;color=#000000;"><input type="button" value="Delete"></a></td>
			</tr>
		<%
	}
%>
